...
public class GenericRandomErrorPlugin : BaseProxyPlugin
{
    ...
    public GenericRandomErrorPlugin(IPluginEvents pluginEvents, IProxyContext context, ISet<UrlToWatch> urlsToWatch, IConfigurationSection? configSection = null) : base(pluginEvents, context, urlsToWatch, configSection)
    {
        _random = new Random();
    }
